...
export default function Changepass() {
  ...
  return (
    <Stack justifyContent="center" alignItems="center" height="100vh" borderTop="50px"> {/* Center the layout */}
    ...
    <form onSubmit={handleSubmit}>
      <Stack spacing={2} sx={{ width: '300px', margin: '0 auto' }}>
        <Typography variant="h5" color="black">Change Password</Typography>
